...
class _TipCourbeState extends State<TipCourbe> {
  ...
  List<ChartSeries<ChartDataCourbes, int>> _createDefaultTensionTemps(List<ChartDataCourbes> dats) {// Liste de la partie Tension/temps, C'est un truc propre aux courbes
                  ...
                  //on affiche la seconde courbe après les :
                    child: SfCartesianChart( //Courbe defaut de tension temps
                        ...
                        primaryXAxis: NumericAxis(
                          minimum: 1,
                          //valeur minimale de l'axe des axis au regard des données
                          maximum: 24,
                        ...
                        title: ChartTitle(text: "Tension(mV) en fonction du temps(Heure)", textStyle: const
                  ...
                  //on affiche la seconde courbe après les :
                    child: SfCartesianChart( //Courbe qui s'affiche lors de l'appui du boutton
                        ...
                        primaryXAxis: NumericAxis(
                          ...
                          maximum:24, //(snapshot.data!.last.temps).toDouble(),   //valeur maximale de l'axe des axis aux regards des données
                        ...
                        title: ChartTitle(text: "Intensité(A) en fonction du temps(Heure)", textStyle: const
                            TextStyle(fontFamily:'Nunito' , fontSize:13.0 , fontStyle:FontStyle.normal,
                                fontWeight:FontWeight.w700, color: Colors.black)),
